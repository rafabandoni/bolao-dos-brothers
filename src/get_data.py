...
class ScrapeData:
    def __init__(self):
        # URL to Format
        self.url_template = "https://www.pro-football-reference.com/years/{year}/games.htm"

    def __enter__(self):
        return self
    
    def get_data(self, years: list):
        try:
            ...
            for year in years:
                ...
                url = self.url_template.format(year=year)  # get the url
                html = urlopen(url)
